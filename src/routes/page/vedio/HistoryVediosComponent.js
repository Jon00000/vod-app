...
// import serverData from '../../../assets/serverHisData'
import styleObj from './LatestVediosComponent.scss'
import Slider from "react-slick"
import { Player } from 'video-react';

class HistoryVediosComponent extends BaseComponent {
  // 构造函数
  constructor (props) {
    super(props);
    let serverData = localStorage.getItem('movie_history');
    if (serverData == null) {
      serverData = []
    } else {
...
export default HistoryVediosComponent;
